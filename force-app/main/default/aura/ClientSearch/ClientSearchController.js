({	
    ...
    divClick : function(component, event, helper) {
        ...
        component.set("v.selectedClientAccountId", accId);
    ...
    SaveSelection : function(component, event, helper){  
        helper.updateCaseforClient(component, event,helper, component.get("v.selectedClientAccountId"), component.get("v.recordId"));        
    },
})