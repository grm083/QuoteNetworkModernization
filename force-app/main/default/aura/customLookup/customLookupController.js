({
    ...
    clear :function(component,event,heplper){
        ...
        component.set('v.isUserSelected', true);
    ...
    closeModel: function(component, event, helper) {
        component.set('v.showHide', false);
                var vx = component.get("v.dashboardTablecancel");
    ...
    assignuser: function(component, event, helper) {
        ...
        var vx = component.get("v.dashboardTable");
        //fire event from child and capture in parent
        $A.enqueueAction(vx);
