({
    ...
    doFetchTask : function(component) {
        ...
        var tabName = $A.get("$Label.c.Open_SFDC_Team_Task_Url");
      ...
      getUserTime : function (component) {
        ...
        action.setCallback(this, function(response){
            ...
            //         hour12: true},sortable : true}
                 ...
                 //SDT-34542 - end
                //{label: 'From Address' fieldName: 'FromAddress', type: 'text', sortable : true},
                //{label: 'To Address' fieldName: 'ToAddress', type: 'text', sortable : true}
